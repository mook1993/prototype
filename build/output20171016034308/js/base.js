	...
	function test(){
		...
		for(var i=0; i<topics.length ;i++){		
			...
			if(i==0){
				...
				$('#remotenav > ul').append("<li class='main active'><a href='#"+ topics[0].innerHTML+"'>"+topics[0].innerHTML+"</a></li>");		

			}else if(topics[i].tagName=="H2"){			

				$('#remotenav > ul').append("<li class='main'><a href='#"+ topics[i].innerHTML+"'>"+topics[i].innerHTML+"</a></li>");

			}else if(topics[i].tagName=="H3"){

				$('#remotenav > ul').append("<li><a href='#"+ topics[i].innerHTML+"'>"+topics[i].innerHTML+"</a></li>");
